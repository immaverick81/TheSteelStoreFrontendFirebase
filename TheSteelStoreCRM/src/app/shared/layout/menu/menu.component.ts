...
export class MenuComponent implements OnInit {
    ...
    ngOnInit() {
        const getUrl: string = this.routeStateService["router"].routerState.snapshot.url;
        this.items = getUrl.includes("crm") ? this.menuDataService.getCrmMenuList() : this.menuDataService.getMenuList();
