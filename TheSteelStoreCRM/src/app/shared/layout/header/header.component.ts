...
export class HeaderComponent implements OnInit {
  ...
  ngOnInit() {
    this.getUrl = this.routeStateService['router'].routerState.snapshot.url;
    this.headerName = this.getUrl.includes('crm') ? 'CRM Management' : 'The Steel Store';
  ...
  logout() {
    ...
    this.getUrl.includes('crm') ? this.router.navigate(['/crm']) : this.router.navigate(['/login']);
  }
